...
In order to test an error page generated by Rails, you would have to toggle Rails' internal `env_config` on the fly, and switch back to the original setting once the test is done.
